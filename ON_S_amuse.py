...
if __name__ == '__main__':
    ...
    S_reconstructed = construct_matrix_from_circulant(construct_circulant(S, False))
    ...
    # stdft = plot_fstdft(signal=signal, ax=axes[1], plot_ref=False, linear=True, d_window=d_window)
    ...
    # plot_signal(signal=signal-reconstructed_signal, ax=axes[3])
