...
if __name__ == "__main__":
    ...
    reconstructed = approximate_window_from_dual_dir(d_test_window, ax_to_plot=axes[2], fig=fig, ax_phase=axes[1])
    # reconstructed = approximate_window_from_k(d_test_window, ax_to_plot=axes[2], fig=fig, ax_phase=axes[1])
